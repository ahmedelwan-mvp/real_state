          ...
          return BaseGradientPage(
            child: BlocConsumer<CompanyAreasBloc, CompanyAreasState>(
              ...
              builder: (context, state) {
                ...
                final errorMessage = state is CompanyAreasFailure
                    ? state.message
                    : null;
                        ...
                        if (hasError)
                          ...
                          Padding(
                            ...
                            child: EmptyStateWidget(
                              description: 'no_company_areas'.tr(),
                            ),
                          ),
                        if (showBrokers) ...[
      ...
      builder: (context, state) {
        ...
        if (state is BrokersListFailure) {
          return AppErrorView(
            ...
            onRetry: () => context.read<BrokersListBloc>().add(
